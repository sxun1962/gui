...
public class InsertPanel extends JPanel implements ActionListener {
	...
	AccessDB3 db3=AccessDB3.getInstance();
	...
	public InsertPanel() {
		...
		//新たにサイトが開かれる＝CDクラスのカウンタが０になる
		//商品番号の最新情報が格納されたcdmaxnumberデータベースをAccessDB3で呼び出す
		//
		db3.connect();
		CD.itemNumCounter = db3.lastNumplus1();
		db3.disconnect();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("登録")) {
			...
			db3.connect();
			CD cd=new CD(CD.itemNumCounter,itemname,singer,genre,Integer.parseInt(price));
			int q=db.insertCDData(cd);
